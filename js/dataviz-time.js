...
d3.tsv("data/data.tsv", type, function(error, data) {//reads the data.tsv file
	...
	//Sets scales
  xScale.domain(d3.extent(data, function(d) { return d.hora; })); //sets xScale depending on hours values
	...
	.attr("x", function(d) { return xScale(d.hora); })
